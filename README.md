...
下面的示例和相关说明都是针对于当前最新版本，如果您使用的是 **1.x** 旧版本，[请戳此处查看v1.x分支Android Support版](https://github.com/jenly1314/ZXingLite/tree/v1.x)[请戳此处查看v1.x分支AndroidX版](https://github.com/jenly1314/ZXingLite/tree/androidx)
